...
TEST(GpuConstructionTime, TestEnd2EndCPUGPU_Laion_1M_512) {
  ...
  std::string save_path_base = "../../indices/laion-1M/laion-gpu-std-r";
  ...
  auto basedata_file_name = "./data/laion-1000000-512/laion-1000000-512.fbin";
  auto gt_file = "./data/laion-1000000-512/gt-1000000-128.ibin";
