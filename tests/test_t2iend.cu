...
TEST(GpuConstructionTime, TestEnd2EndCPUGPU_T2I_10M_200) {
  ...
  std::string save_path_base = "../../indices/t2i-10M/t2i-gpu-std-r";
  ...
  auto basedata_file_name = "./data/t2i-10000000-200/t2i_10000000_200.fbin";
  auto gt_file = "./data/t2i-10000000-200/gt_10000000_128.ibin";
